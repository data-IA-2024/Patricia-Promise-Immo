...
df[rempli].to_parquet('all_immo_no_empty.parquet')
...
df = pd.read_parquet('all_immo_no_empty.parquet')
...
df_final = df_final.drop(columns=['Unnamed: 0','No voie','Prefixe de section','No disposition','Surface reelle bati'])


df_final.to_parquet('features_immo_data.parquet')